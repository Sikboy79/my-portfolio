          ...
          <group key={i} position={[0, yPos, 0]}>
            ...
            {i === 0 && logo && (
              <group rotation={[-Math.PI / 2, 0, 0]} position={[0, cardHeight / 2 + 0.25, 0]}>
                <Text position={[-0.6, 0.25, -0.18]} fontSize={0.08} color="#111" anchorX="left" anchorY="middle">Ryan Cook</Text>
                <Text position={[-0.6, 0.16, -0.18]} fontSize={0.045} color="blue" anchorX="left" anchorY="middle">Software Developer</Text>
                <Text position={[-0.6, 0.08, -0.18]} fontSize={0.045} color="#555" anchorX="left" anchorY="middle">TheSikworks@gmail.com</Text>
                <Text position={[-0.6, 0.001, -0.18]} fontSize={0.045} color="#555" anchorX="left" anchorY="middle">https://github.com/Sikboy79</Text>
                <Text position={[-0.6, -0.09, -0.18]} fontSize={0.045} color="#555" anchorX="left" anchorY="middle">-Portfolio here-</Text>
                <Text position={[-0.4, -0.3, -0.18]} fontSize={0.045} color="#555" anchorX="left" anchorY="middle">"Inhale problems, exhale solutions!"</Text>
...
function Lid({ open, width, depth, radius, textures, loading }) {
  ...
  const [armMap, normalMapGL, colorMap, displacementMap, normalMapDX, roughnessMap] = textures;
...
// ----- Hollow Box -----
function HollowBox({ width, height, depth, wallThickness, radius, textures, loading }) {
  // if (loading)
  //   return <SkeletonBox width={width} height={0.1} depth={depth} radius={radius} position={[0, 0.25, -depth / 2]} />;
